...
$link=Conectarse();
$sql="SELECT p.idmaeprov,p.codigo,p.ruc,p.alias,p.nombre,p.direccion,
p.telefono,p.representante,p.distritos_iddistritos,
d.descripcion FROM maeprov as p INNER JOIN distritos as d 
ON p.distritos_iddistritos=d.iddistritos WHERE idmaeprov=$ID";
...
<h1 class="page-header text-success">Actualizar Proveedor</h1>
<h5 class="text-right">
...
<a href="../eliminar/proveedor?id=<?php echo $ID; ?>" class="btn btn-danger">ELIMINAR</a>
