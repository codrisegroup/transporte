...
$consulta = "SELECT codigo_reporte,area,date_format(fecha,'%d-%m-%Y')as fecha, 
centro_costo, SUM( costo ) AS costo
FROM reporte_det
...
$titulosColumnas=
array('CODIGO', 'ÁREA', 'CENTRO DE COSTO', 'COSTO','PORCENTAJE','FECHA');
...
->setCellValueExplicit('E'.$i,  $fila['costo']*1.18 ,PHPExcel_Cell_DataType::TYPE_NUMERIC)
->setCellValueExplicit('F'.$i,  $fila['fecha'],PHPExcel_Cell_DataType::TYPE_STRING);
$i++;
}
