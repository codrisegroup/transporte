...
<head>
<meta charset="UTF-8">
<title>REPORTE X TRANSPORTISTAS</title>
...
<form action="reporte-cc" method="POST">
...
<?php
$link=Conectarse();
$Sql="SELECT centcos_reporte from reporte_transporte  where estado='00'
group by centcos_reporte 
;";
$result=mysql_query($Sql) or die(mysql_error());
while ($row=mysql_fetch_array($result)) {
?>
<option value ="<?php echo $row['centcos_reporte']?>">
<?php echo $row['centcos_reporte']?></option>
<?php }?>
</select>
</div>
</div>
...
<div class="col-md-2 column">
<br>
<form action="../actualizar/reporte-cc.php" method="POST">
