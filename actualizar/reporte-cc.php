...
$Sql="UPDATE reporte_transporte SET estado='01' and  
numero_reporte='$NUMERO' WHERE 
fecha_reporte BETWEEN '$FECHAINICIO' AND '$FECHAFIN'
AND proveedor_idproveedor='$TRANSPORTISTA' AND 
centcos_reporte='$CC'";
...
window.location='/transporte/reportes/reporte-cc';
